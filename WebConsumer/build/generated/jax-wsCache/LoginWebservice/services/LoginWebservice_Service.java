 ...
 * 
 */
@WebServiceClient(name = "LoginWebservice", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8080/EnterpriseApplication-war/LoginWebservice?WSDL")
    ...
    extends Service
{
    ...
    private final static QName LOGINWEBSERVICE_QNAME = new QName("http://service/", "LoginWebservice");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/EnterpriseApplication-war/LoginWebservice?WSDL");
    ...
    public LoginWebservice getLoginWebservicePort() {
        return super.getPort(new QName("http://service/", "LoginWebservicePort"), LoginWebservice.class);
    }
    ...
    public LoginWebservice getLoginWebservicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "LoginWebservicePort"), LoginWebservice.class, features);
    }
